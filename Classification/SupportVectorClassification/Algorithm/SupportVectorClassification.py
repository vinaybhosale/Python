...
from Python.Classification.SupportVectorClassification.Model.SupportVectorModel import *
...
class SupportVectorClassification:
    ...
    def display_predicted_output(self):
        try:
            ...
            SupportVectorModel.create_save_pickle(self, test_csv_path, classifier)
